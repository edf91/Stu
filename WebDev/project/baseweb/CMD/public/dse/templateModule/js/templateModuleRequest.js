define('../js/${module}Request',['dseCommon'],function(require,exports,module){
    ...
    var ${module}Request = {
        ...
        getTemplateOfName: function(params){
            params.url = this.DIR + '${projectName}' + '/' + '${module}' + '/views/template/' + params.templateName;
    ...
    module.exports.${module}Request = ${module}Request;
})