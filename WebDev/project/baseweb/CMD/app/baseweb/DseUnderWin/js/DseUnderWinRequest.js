define('../js/DseUnderWinRequest',['dseCommon'],function(require,exports,module){
    var DseConstant = require('dseCommon').DseCommon.DseConstant;
    var DseRequest = require('dseCommon').DseCommon.DseRequest;

    var DseUnderWinRequest = {
        CLIENT_PATH : DseConstant.DsePath.CLIENT_PATH,
        SERVER_PATH : DseConstant.DsePath.SERVER_PATH,
        SUFFIX : '.do',
        DIR: 'app/',
        listDist: function(params){
            params.url = 'app/baseweb/DseUnderWin/datas/dseDistWin.json';
            this.requestClientTest(params);
        },
        getTemplateOfName: function(params){
            params.url = this.DIR + 'baseweb' + '/' + 'DseUnderWin' + '/views/template/' + params.templateName;
    ...
    module.exports.DseUnderWinRequest = DseUnderWinRequest;
})